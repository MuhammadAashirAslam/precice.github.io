...
- If content already exists on another site, prefer linking to it. Simplifying, customizing, or summarizing external content is fine. Don't copy chunks of documentation.
